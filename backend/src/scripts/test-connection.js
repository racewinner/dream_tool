...
console.log('Using database configuration:', {
    ...
    password: config_1.config.database.password ? '***' : '(empty)'
});
var testConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
    var sequelize, results, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, sequelize.query('SELECT current_database(), current_user, version()')];
            case 3:
                results = (_a.sent())[0];
            ...
            case 5: return [4 /*yield*/, sequelize.close()];
            case 6:
                _a.sent();

...
var CacheService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.redis.set(key, data, 'EX', ttl || this.CACHE_TTL)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        console.error('Error setting cache:', error_1);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        console.error('Error getting cache:', error_2);
                        return [2 /*return*/, null];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_3 = _a.sent();
                        console.error('Error deleting cache:', error_3);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    CacheService.prototype.generateCacheKey = function (type, latitude, longitude, date) {
        return "weather:".concat(type, ":").concat(latitude, ":").concat(longitude, ":").concat(date || 'current');
    };
    return CacheService;
}());
